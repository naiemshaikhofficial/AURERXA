...
import { submitJewelryCare } from '@/app/services-actions'
            ...
            <main>
                        ...
                        <div className="flex flex-col md:flex-row gap-16 items-center">
                            ...
                            >
                                <div className="inline-flex items-center gap-2 px-3 py-1 bg-muted border border-border rounded-full">
                                    ...
                                    <span className="text-[10px] uppercase tracking-[0.2em] text-primary font-bold">The Art of Preservation</span>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    <div className="p-4 bg-card border border-border rounded-2xl flex items-center gap-4">
                                        ...
                                        <span className="text-xs uppercase tracking-[0.1em] text-muted-foreground font-medium leading-tight">Lifetime <br />Warranty Support</span>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <div className="flex-1 relative aspect-square w-full max-w-sm md:max-w-md">
                                ...
                                />
                                <div className="absolute inset-10 bg-gradient-to-br from-card to-background rounded-full border border-border flex items-center justify-center overflow-hidden">
                ...
                <section className="py-24 px-6 bg-muted/30">
                    <div className="container max-w-7xl mx-auto space-y-16">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-muted-foreground font-light italic">Precision in every touch.</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className="p-12 border border-border bg-card rounded-3xl transition-all space-y-6"
                                >
                ...
                <section className="py-32 px-6">
                    <div className="container max-w-6xl mx-auto">
                        <div className="bg-card grid lg:grid-cols-2 rounded-[3.5rem] overflow-hidden border border-border shadow-2xl">
                            <div className="relative p-16 flex flex-col justify-between">
                                ...
                                <div className="relative z-10 pt-16 flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-bold">50+</div>
                                    <p className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold leading-tight">Years of Expertise <br />in Fine Jewelry</p>
                                </div>
                            </div>

                            <div className="p-16 bg-muted/10">
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                                    <div className="space-y-2">
                                        <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold ml-1">Patron Name</Label>
                                        <Input
                                            {...register('name')}
                                            placeholder="Enter your name"
                                            className="bg-transparent border-0 border-b border-border rounded-none h-12 focus-visible:ring-0 focus:border-primary transition-colors text-lg font-light"
                                        />
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className="bg-transparent border-0 border-b border-border rounded-none h-12 focus-visible:ring-0 focus:border-primary transition-colors font-light"
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold ml-1">Phone Number</Label>
                                            <Input
                                                {...register('phone')}
                                                type="tel"
                                                placeholder="+91 ...."
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                        <SelectTrigger className="bg-transparent border-0 border-b border-border rounded-none h-12 focus:ring-0 focus:border-primary px-0 text-foreground">
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold ml-1">Preferred Date</Label>
                                            <Input
                                                type="date"
                                                {...register('date')}
                                    ...
                                    <Button disabled={isLoading} className="w-full bg-primary hover:bg-foreground hover:text-background text-primary-foreground font-bold uppercase tracking-[0.4em] h-20 rounded-full transition-all duration-500 group">
