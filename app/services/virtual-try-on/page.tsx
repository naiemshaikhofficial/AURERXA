...
import { submitVirtualTryOn } from '@/app/services-actions'
                        ...
                        <div className="grid lg:grid-cols-2 gap-20 items-center">
                            ...
                            >
                                <div className="inline-flex items-center gap-2 px-3 py-1 bg-muted border border-border rounded-full">
                                    ...
                                    <span className="text-[10px] uppercase tracking-[0.3em] text-primary font-bold">Innovation in Luxury</span>
                                </div>
                                ...
                                <h1 className="text-6xl md:text-8xl font-serif leading-[1.1] tracking-tighter italic">
                                    ...
                                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground/80 to-primary/50">Excellence.</span>
                                </h1>
                                ...
                                <div className="flex gap-10 pt-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-[10px] uppercase tracking-widest text-muted-foreground">Concierge</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="relative w-full h-full bg-[#111] rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute top-10 right-10 p-4 bg-card/10 backdrop-blur-md border border-border rounded-xl"
                                    >
                ...
                <section className="py-32 px-6">
                    <div className="container max-w-7xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="md:col-span-2 group relative h-[500px] rounded-3xl overflow-hidden border border-border bg-card backdrop-blur-sm p-12 flex flex-col justify-end">
                                <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_0%_0%,_hsl(var(--primary)_/_0.1)_0%,_transparent_50%)]" />
                                <Camera className="absolute top-12 left-12 text-primary/10 w-32 h-32 -rotate-12 group-hover:rotate-0 transition-transform duration-700" strokeWidth={0.5} />
                            ...
                            <div className="group relative rounded-3xl overflow-hidden border border-border bg-muted/30 p-12 flex flex-col gap-8 transition-all hover:bg-muted/50">
                            ...
                            <div className="group relative rounded-3xl overflow-hidden border border-border bg-card p-12 flex flex-col gap-8">
                            ...
                            <div className="md:col-span-2 group relative h-[400px] rounded-3xl overflow-hidden bg-card border border-border p-12 flex items-center justify-between">
                ...
                <section className="py-32 px-6 relative">
                    <div className="container max-w-2xl mx-auto">
                        <div className="text-center mb-16 space-y-4">
                            ...
                            <p className="text-muted-foreground font-light italic">Your journey with AURERXA begins here.</p>
                        </div>

                        <div className="bg-card border border-border p-12 rounded-[2rem] relative overflow-hidden group shadow-2xl">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 blur-3xl group-hover:bg-primary/20 transition-colors" />
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            className="bg-transparent border-0 border-b border-border rounded-none h-12 focus-visible:ring-0 focus:border-primary transition-colors placeholder:text-muted-foreground/20"
                                        />
                                ...
                                <div className="space-y-3">
                                    <Label className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-bold ml-1">Phone Number</Label>
                                    <Input
                                        {...register('phone')}
                                        type="tel"
                                        placeholder="+91 ...."
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        <Label className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-bold ml-1">Preferred Date</Label>
                                        <Input
                                            type="date"
                                            {...register('date')}
                                            className="bg-transparent border-0 border-b border-border rounded-none h-12 focus-visible:ring-0 focus:border-primary transition-colors"
                                        />
                                    </div>
                                    <div className="space-y-3">
                                        <Label className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-bold ml-1">Preferred Time</Label>
                                        <Input
                                            type="time"
                                            {...register('time')}
                                            className="bg-transparent border-0 border-b border-border rounded-none h-12 focus-visible:ring-0 focus:border-primary transition-colors"
                                ...
                                <Button
                                    disabled={isLoading}
                                    className="w-full bg-primary hover:bg-foreground hover:text-background text-primary-foreground font-bold uppercase tracking-[0.4em] h-16 rounded-full transition-all duration-500 group shadow-[0_0_20px_rgba(191,155,101,0.2)]"
                                >
                                    {isLoading ? (
