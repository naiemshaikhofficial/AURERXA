...
import { submitBoutiqueVisit } from '@/app/services-actions'
            ...
            <main>
                ...
                <section className="relative h-[100vh] flex items-center justify-center pt-20 overflow-hidden">
                    <div className="absolute inset-0">
                        <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2000&auto=format&fit=crop" className="w-full h-full object-cover opacity-10 grayscale scale-110" alt="Boutique" />
                            ...
                            >
                                ...
                                <div className="flex gap-8 pt-6">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] uppercase tracking-widest text-muted-foreground">Private Consultation</span>
                                    </div>
                                    <div className="w-px h-12 bg-border" />
                                    <div className="flex flex-col">
                                        <span className="text-3xl font-serif text-primary">VIP</span>
                                        <span className="text-[10px] uppercase tracking-widest text-muted-foreground">Hospitality Access</span>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                    ...
                    >
                        ...
                        <span className="text-[10px] uppercase tracking-[0.4em] text-muted-foreground italic">Scroll for Experience</span>
                    </motion.div>
                </section>
                    ...
                    <div className="container max-w-7xl mx-auto grid md:grid-cols-2 gap-32 items-center">
                        <div className="space-y-12 order-2 md:order-1">
                            <div className="flex gap-10 items-start group">
                                <div className="w-16 h-16 rounded-full bg-muted flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-primary-foreground transition-all">
                                    <UserCheck size={24} strokeWidth={1} />
                                </div>
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-serif italic">Dedicated Stylist</h3>
                                    <p className="text-muted-foreground font-light leading-relaxed">Experience a curated selection guided by a specialist who understands your unique style profile and preferences.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-10 items-start group">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-muted-foreground font-light leading-relaxed">Browse our most exclusive high-jewelry collections in the comfort of our private VIP consultation suites.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-10 items-start group">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-muted-foreground font-light leading-relaxed">Book a visit at any of our flagship boutiques in major global luxury capitals.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative aspect-[4/5] order-1 md:order-2">
                            ...
                            <div className="relative h-full w-full rounded-[2rem] overflow-hidden border border-border">
                                ...
                                <div className="absolute inset-x-0 bottom-0 p-12 bg-gradient-to-t from-background to-transparent">
                ...
                <section className="py-48 px-6 bg-gradient-to-b from-transparent to-muted/30">
                    <div className="container max-w-4xl mx-auto">
                        ...
                        <div className="bg-card border border-border p-16 rounded-[4rem] shadow-3xl">
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
                                <div className="grid md:grid-cols-2 gap-12">
                                    <div className="space-y-4">
                                        <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold">Your Full Name</Label>
                                        <Input
                                            {...register('name')}
                                            placeholder="Enter name"
                                            className="bg-transparent border-0 border-b border-border rounded-none h-14 focus-visible:ring-0 focus:border-primary transition-colors text-xl font-light"
                                        />
                                    </div>
                                    <div className="space-y-4">
                                        <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold">Contact Email</Label>
                                        <Input
                                            {...register('email')}
                                            type="email"
                                ...
                                <div className="grid md:grid-cols-3 gap-12">
                                    <div className="space-y-4">
                                        <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold">Phone</Label>
                                        <Input
                                            {...register('phone')}
                                            type="tel"
                                            placeholder="+91 ..."
                                            className="bg-transparent border-0 border-b border-border rounded-none h-14 focus-visible:ring-0 focus:border-primary transition-colors font-light"
                                        />
                                    </div>
                                    <div className="space-y-4">
                                        <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold">Date</Label>
                                        <Input
                                            type="date"
                                            {...register('date')}
                                            className="bg-transparent border-0 border-b border-border rounded-none h-14 focus-visible:ring-0 focus:border-primary transition-colors"
                                        />
                                    </div>
                                    <div className="space-y-4">
                                        <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold">Time</Label>
                                        <Input
                                            type="time"
                                            {...register('time')}
                                            className="bg-transparent border-0 border-b border-border rounded-none h-14 focus-visible:ring-0 focus:border-primary transition-colors"
                                ...
                                <div className="space-y-4">
                                    <Label className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold">Areas of Interest (Purpose)</Label>
                                    <Textarea
                                        {...register('purpose')}
                                        placeholder="e.g. Bridal Selection, Bespoke Creations..."
                                        className="bg-transparent border-0 border-b border-border rounded-none h-24 focus-visible:ring-0 focus:border-primary transition-colors resize-none font-light italic"
                                    />
                                </div>
                                ...
                                <Button disabled={isLoading} className="w-full bg-primary hover:bg-foreground hover:text-background text-primary-foreground font-bold uppercase tracking-[0.5em] h-24 rounded-full transition-all duration-700 shadow-2xl flex items-center justify-center gap-4">
