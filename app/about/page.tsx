    ...
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 overflow-x-hidden">
            ...
            <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden" style={{ transform: 'translateZ(0)' }}>
                ...
                <motion.div style={{ y: yText, opacity: opacityFade, willChange: 'transform, opacity' }} className="relative z-20 text-center max-w-7xl px-6">
                    <motion.div
                        ...
                        className="space-y-6"
                    >
                        <span className="text-primary text-[10px] md:text-xs tracking-[0.8em] uppercase font-bold block mb-4">
                            The AURERXA Legacy
                        </span>
                        <h1 className="text-6xl md:text-[10rem] font-serif font-black tracking-tighter leading-[0.8] italic text-foreground">
                            BUILT ON <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-500 to-amber-700">CRAFT.</span>
                        </h1>
                        <p className="max-w-xl mx-auto text-muted-foreground text-xs md:text-sm tracking-[0.4em] font-light italic mt-10">
            ...
            <main className="relative z-10">
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 items-center">
                        <FadeInScroll>
                            <div className="space-y-8 md:space-y-12">
                                <h2 className="text-5xl md:text-7xl font-serif font-bold italic leading-tight tracking-tighter group text-foreground">
                                    A Story of <br />
                                ...
                                <p className="text-xl md:text-2xl text-muted-foreground font-light leading-relaxed italic border-l-2 border-primary/10 pl-8">
                        ...
                        <div className="relative aspect-[3/4] md:aspect-[4/5] overflow-hidden group border border-border bg-card shadow-2xl rounded-sm" style={{ transform: 'translateZ(0)' }}>
                            ...
                            <div className="absolute bottom-8 left-8 z-30 opacity-0 group-hover:opacity-100 transition-all duration-700 translate-y-2 group-hover:translate-y-0">
                                <p className="text-primary text-[10px] tracking-[0.5em] font-bold uppercase mb-1">Founding Artisan</p>
                                <h3 className="text-2xl font-serif italic font-bold text-foreground">Bapan Hembromb</h3>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="relative py-32 md:py-48 overflow-hidden bg-background/50">
                    <GoldParticles count={10} />
                    <div className="max-w-5xl mx-auto px-6 text-center relative z-20">
                        <FadeInScroll>
                            <div className="space-y-12 md:space-y-16">
                                <span className="text-primary/60 text-xs tracking-[1em] uppercase font-bold">The Industry Reality</span>
                                <p className="text-3xl md:text-5xl font-serif italic text-foreground/90 leading-tight tracking-tight">
                                    "For generations, traditional goldsmith shops held <span className="text-primary drop-shadow-[0_0_15px_rgba(245,158,11,0.1)]">strict monopolies</span>, forbidding Bengali artisans from selling directly to the world."
                                </p>
                                <div className="space-y-8 max-w-3xl mx-auto">
                                    <div className="w-px h-20 bg-gradient-to-b from-primary/30 to-transparent mx-auto" />
                                    <p className="text-lg md:text-xl text-muted-foreground font-light tracking-wide leading-relaxed italic">
                                        <span className="block text-foreground/80 mb-4 not-italic font-medium underline decoration-primary/10 underline-offset-8">"The creators were silenced."</span>
                ...
                <section className="py-24 md:py-40 px-6 relative overflow-hidden">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 items-center">
                        <div className="order-2 md:order-1 relative aspect-[3/4] md:aspect-square overflow-hidden group border border-border bg-card shadow-2xl rounded-sm" style={{ transform: 'translateZ(0)' }}>
                            ...
                            <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 p-6 md:p-10 bg-background/80 backdrop-blur-3xl border-l-4 border-primary shadow-lg">
                                <p className="text-foreground font-serif text-2xl md:text-3xl italic tracking-tighter leading-none">Handcrafted Honor.</p>
                                <p className="text-primary/80 text-[10px] uppercase tracking-[0.4em] font-bold mt-4">The Mission</p>
                            </div>
                        </div>

                        <FadeInScroll delay={0.1}>
                            <div className="order-1 md:order-2 space-y-8 md:space-y-12">
                                <h2 className="text-5xl md:text-7xl font-serif font-bold italic leading-tight tracking-tighter text-foreground">
                                    Born to <br />
                                    <span className="text-primary">Change.</span>
                                </h2>
                                <p className="text-lg md:text-xl text-muted-foreground font-light leading-relaxed italic border-l border-border pl-8">
                                ...
                                <div className="space-y-6 pt-6">
                                    <p className="text-muted-foreground italic text-base leading-loose">
                ...
                <section className="relative min-h-[80vh] flex items-center py-32 md:py-0 overflow-hidden" style={{ transform: 'translateZ(0)' }}>
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <FadeInScroll>
                            <div className="h-fit bg-card/60 backdrop-blur-2xl border border-border p-10 md:p-14 space-y-10 shadow-3xl rounded-sm ring-1 ring-border">
                                <h2 className="text-5xl md:text-7xl font-serif font-black italic tracking-tighter leading-[0.9] text-foreground">
                                    They are <br />
                                    <span className="text-primary">Family.</span>
                                </h2>
                                <div className="space-y-8">
                                    <p className="text-xl md:text-2xl text-muted-foreground font-light leading-snug italic">
                                        Worked with <span className="text-foreground font-medium">thousands of craftsmen</span>, together delivering <span className="text-foreground font-medium">millions of pieces</span>.
                                    </p>
                                    <div className="w-16 h-px bg-primary/30" />
                                    <p className="text-lg md:text-xl text-primary font-medium italic tracking-tight leading-relaxed">
                        ...
                        <div className="hidden lg:flex flex-col gap-12 justify-center py-10">
                            <motion.div
                                ...
                                className="relative w-[450px] aspect-[2/3] overflow-hidden border border-border group shadow-2xl mx-auto rounded-sm"
                            ...
                            >
                                ...
                                <div className="absolute bottom-8 left-8 right-8">
                                    <p className="text-primary text-[10px] tracking-[0.4em] font-bold uppercase mb-2">Senior Artist</p>
                            ...
                            <FadeInScroll>
                                <div className="space-y-12">
                                    <div className="space-y-6">
                                        <span className="text-primary/60 uppercase tracking-[0.5em] text-xs font-bold block">Foundation & Leadership</span>
                                        <h2 className="text-5xl md:text-7xl font-serif font-black italic tracking-tighter text-foreground leading-[0.8]">
                                            Founder <br />
                                    ...
                                    <div className="space-y-10 text-xl text-muted-foreground font-light leading-relaxed italic">
                                        <p className="border-l-2 border-primary/10 pl-10">
                ...
                <section className="py-48 px-6 text-center relative overflow-hidden" style={{ transform: 'translateZ(0)' }}>
                    ...
                    <FadeInScroll>
                        <div className="max-w-4xl mx-auto space-y-12 relative z-20">
                            <div className="h-[1px] w-20 bg-primary/20 mx-auto" />
                            <h2 className="text-5xl md:text-8xl font-serif font-black text-foreground italic tracking-tighter leading-none">
                                Integrity in <br />
                                <span className="text-primary">Every Shine.</span>
                            </h2>
                            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed font-light italic max-w-2xl mx-auto">
                            ...
                            <div className="pt-24 space-y-6">
                                <p className="text-3xl md:text-5xl font-serif italic text-foreground tracking-widest opacity-80">
                                    Respect, Handcrafted.
                                </p>
                                <p className="text-primary tracking-[0.8em] font-bold uppercase text-[10px]">
                                    — Team AURERXA —
                                </p>
                            </div>
                        </div>
