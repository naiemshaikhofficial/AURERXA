            ...
            <main className="pt-40 pb-40">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    ...
                    <div className="text-center mb-32 relative">
                        ...
                        <h1 className="mt-12 text-5xl md:text-8xl font-serif font-bold tracking-tight text-foreground italic">
                            Our <span className="text-primary">Boutique</span>
                        </h1>

                        <p className="mt-12 text-sm md:text-base text-muted-foreground max-w-2xl mx-auto font-light leading-loose tracking-widest italic">
                    ...
                    >
                        <div className="group bg-card border border-border hover:border-primary/20 transition-all duration-1000 shadow-2xl overflow-hidden">
                            <div className="grid grid-cols-1 lg:grid-cols-5 h-full">
                                {/* Map iframe Integration */}
                                <div className="lg:col-span-3 relative min-h-[500px] bg-muted overflow-hidden group/map">
                                    <iframe
                                    ...
                                    />
                                    <div className="absolute top-0 right-0 w-32 h-32 border-t border-r border-border m-8 pointer-events-none" />
                                    <div className="absolute bottom-0 left-0 w-32 h-32 border-b border-l border-border m-8 pointer-events-none" />
                                    ...
                                    <div className="absolute bottom-6 right-6 opacity-0 group-hover/map:opacity-100 transition-opacity duration-300">
                                        <a
                                            ...
                                            className="px-4 py-2 bg-foreground text-background text-[9px] uppercase tracking-widest font-bold shadow-2xl hover:bg-primary hover:text-primary-foreground transition-colors"
                                        >
                                            Direct Link →
                                        </a>
                                    </div>
                                ...
                                <div className="lg:col-span-2 p-12 md:p-16 flex flex-col justify-center space-y-12">
                                    <div className="space-y-10">
                                        <div className="space-y-2">
                                            <p className="text-primary/60 text-[9px] uppercase tracking-[0.4em] font-premium-sans">Heritage House</p>
                                            <h2 className="font-serif text-3xl text-foreground italic tracking-wide">{store.name}</h2>
                                        </div>
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center justify-center gap-4 w-full py-5 bg-primary text-primary-foreground text-[9px] uppercase tracking-[0.4em] font-bold hover:bg-foreground hover:text-background transition-all duration-700 shadow-2xl"
                                    >
                        ...
                        <div className="bg-[#004028] px-12 py-24 md:py-32 text-center relative overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-12">
                                ...
                                <h3 className="text-4xl md:text-7xl font-serif font-bold text-white tracking-tight italic">
                                    Private <span className="text-primary">Consultation</span>
                                </h3>
