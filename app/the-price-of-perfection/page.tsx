...
export default function PriceOfPerfectionPage() {
            ...
            <section ref={containerRef} className="pt-32 pb-16 md:py-48 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-8xl font-serif text-white/90 italic tracking-tighter">The Price of Perfection</h1>
                        <p className="text-white/40 max-w-lg mx-auto leading-relaxed font-light text-[10px] md:text-base uppercase tracking-widest">
