...
export default function ContactClient({ contactConfig }: { contactConfig: any }) {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
                        ...
                        <div className="lg:col-span-1 space-y-8">
                            <div className="p-6 bg-card border border-border">
                                ...
                                <p className="text-muted-foreground font-light">{contactConfig.email}</p>
                            ...
                            <div className="p-6 bg-card border border-border">
                                ...
                                <p className="text-muted-foreground font-light">{contactConfig.phone}</p>
                                <p className="text-sm text-muted-foreground/60 mt-1 font-light">
                            ...
                            <div className="p-6 bg-card border border-border mt-auto">
                                ...
                                <div className="space-y-4">
                                    <p className="text-muted-foreground font-light leading-relaxed whitespace-pre-line text-sm uppercase tracking-wide">
                            ...
                            <div className="p-6 bg-card border border-border">
                                ...
                                <ul className="space-y-2 text-sm text-muted-foreground font-light px-0 list-none">
                        ...
                        <div className="lg:col-span-2 border border-border p-8 bg-card">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                {status === 'success' && (
                                    <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-sm animate-in fade-in slide-in-from-bottom-2 duration-700">
                                ...
                                {status === 'error' && (
                                    <div className="p-4 bg-red-500/10 border border-red-500/20 text-red-500 text-sm animate-in fade-in slide-in-from-bottom-2 duration-700">
                                        <div className="flex items-center justify-center gap-3">
