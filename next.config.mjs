    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              `script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.jsdelivr.net https://checkout.razorpay.com https://sdk.cashfree.com https://vercel.live https://va.vercel-scripts.com https://www.googletagmanager.com https://connect.facebook.net https://www.google-analytics.com https://*.ccavenue.com`,
              ...
              "connect-src 'self' https://*.supabase.co https://cdn.jsdelivr.net https://*.razorpay.com https://*.cashfree.com https://*.google.com https://*.googleapis.com https://www.goldapi.io https://va.vercel-scripts.com https://vitals.vercel-insights.com https://www.google-analytics.com https://connect.facebook.net https://vercel.live https://www.merchant-center-analytics.goog https://secure.ccavenue.com https://*.ccavenue.com",
              ...
              "base-uri 'self'",
              "form-action 'self' https://secure.ccavenue.com https://*.ccavenue.com"
            ].join('; '),
          },
          {
